              ...
              const textImg = (teks) => {
                ...
                const fgi = {
                  ...
                  message: { 
                                ...
                                'gifPlayback': 'true', 
                                'caption': `Deepak`,
                                'jpegThumbnail': fs.readFileSync('./Assets/Deepak.jpg')
                                       }
                                      }
                                   } 
...
if (!isCreator) return replay(mess.botowner)
if (args[0] === "on") {
if (isBanChat) return replay('This Group is Already Banned from using DeepakBot!')
banchat.push(from)
replay('This Group has been banned from using DeepakBot!')
...
replay('This Group has been *unbanned* from using DeepakBot!')
} else {
  let buttonsntnsfw = [
...
case 'repo': case 'botrepo':
    ...
    reply(`My Source Code is - https://youtube.com/@dreamguydeepak`)
    break
...
await SPARKY.sendMessage(m.chat, { delete: key })
 ...
 let teks = ` 「  Deepak group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
 for (let i of anu) {
...
case 'swm': case 'take': case 'stickerwm': case 'take':{
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
if (!args.join(" ")) return reply(`Use command: .take SPARKY`)
const swn = args.join(" ")
...
┃☣️ 𝘜𝘴𝘦𝘳 :  ${pushname}
┃☣️ 𝘗𝘳𝘦𝘧𝘪𝘹 :  ${prefix}
┃☣️ 𝘉𝘰𝘵 𝘚𝘱𝘦𝘦𝘥 : ${latensie.toFixed(4)} ms
┃☣️ 𝘙𝘶𝘯 𝘛𝘪𝘮𝘦 :  ${runtime(process.uptime())}
┃☣️ Bot Number : "917029257330"
┃☣️ 𝘖𝘸𝘯𝘦𝘳 𝘕𝘶𝘮𝘣𝘦𝘳 : "918348225320"
╰═════════════════⊷
...
╰════🦄Deepak-Bot═════⊷`
 ...
 let buttonshelpm = [
    {buttonId: `.owner`, buttonText: {displayText: 'Bot Owner'}, type: 1}
                ...
                let buttonMessage = {
                    video:fs.readFileSync('./system/Deepak.jpg'),gifPlayback:true,
                    caption: helpmenu,
                    footer: `${BotName}`,
...
const SPARKYarray= [
            ...
            "https://c.tenor.com/FDe7lTs0xvMAAAPo/SPARKY-Bot-Bot-Deepak.jpg",
            ...
            "https://c.tenor.com/Fz9xGVR_FHAAAAPo/SPARKY-Bot-Bot-Deepak.jpg",
            ...
            "https://c.tenor.com/AULffc4ZKFIAAAPo/SPARKY-god-Deepak.jpg",
            "https://c.tenor.com/Y8Y1GbmQSOIAAAPo/SPARKY-Bot-quintessential-quintuplets.mp4",
            "https://c.tenor.com/m0EjrelpOfkAAAPo/SPARKY-Bot-Bot-Deepak.jpg",
